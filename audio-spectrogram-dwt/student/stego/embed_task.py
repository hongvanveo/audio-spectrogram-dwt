...
def get_inputs():
    ...
    # Khoa duoc chia se giua ben gui va ben nhan de tron ngau nhien anh truoc khi nhung.
    ...
    return COVER_FILE, SECRET_IMAGE, PERMUTATION_KEY, output_audio


def main():
    cover_file, secret_image, permutation_key, output_audio = get_inputs()
    cmd = [
        "python3",
    ...
    print(f"Da nhung anh {secret_image} vao {output_audio} su dung audio {cover_file} voi key {permutation_key}.")
